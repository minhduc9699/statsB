    ...
    <>
      ...
      <div className="grid grid-cols-12 gap-[6px] px-[24px] bg-gray-100 overflow-hidden">
        <div className="col-span-2">
          <TeamsFilter filters={filters} onChange={setFilters} />
        </div>
                ...
                >
                  <div className="grid grid-cols-12">
                    <div className="flex items-center justify-start space-x-[20px] col-span-2">
                      <img src={Bonston} alt="team-logo" className="h-[40px]" />
                    ...
                    <div className="flex items-center justify-between col-span-4">
                      <div className="flex flex-col space-y-[10px] items-center justify-start w-1/2">
                        <div className="flex items-center justify-start space-x-[10px] w-full">
                          <span className="text-[20px] font-bold">
                            {team.roster.length > 0
                              ? String(team.roster[0].jerseyNumber).padStart(
                                  2,
                                  "0"
                                )
                              : "02"}
                        ...
                        <div className="flex items-center justify-start space-x-[10px] w-full">
                          <span className="text-[20px] font-bold">
                            {team.roster.length > 0
                              ? String(team.roster[2].jerseyNumber).padStart(
                                  2,
                                  "0"
                                )
                              : "37"}
                      ...
                      <div className="flex flex-col space-y-[10px] items-start justify-start w-1/2">
                        <div className="flex items-center justify-start space-x-[10px] w-full">
                          <span className="text-[20px] font-bold">
                            {team.roster.length > 0
                              ? String(team.roster[1].jerseyNumber).padStart(
                                  2,
                                  "0"
                                )
                              : "92"}
                        ...
                        <div className="flex items-center justify-start space-x-[10px] w-full">
                          <span className="text-[20px] font-bold">
                            {team.roster.length > 0
                              ? String(team.roster[3].jerseyNumber).padStart(
                                  2,
                                  "0"
                                )
                              : "22"}
